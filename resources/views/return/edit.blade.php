            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => ['returns.update', $lsms_return_data->id], 'method' => 'put', 'files' => true, 'id' => 'purchase-form']) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <p><strong>{{$lsms_return_data->reference_no}}</strong> </p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><strong>{{trans('file.Customer')}} *</strong></label>
                                            <input type="hidden" name="customer_id_hidden" value="{{$lsms_return_data->customer_id}}">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td><input type="number" name="qty[]" class="form-control qty" value="{{$product_return_data->qty}}" step="any" required></td>
                                                       <td><input type="number" name="product_price[]" class="form-control product-price" value="{{$product_return_data->product_price}}" step="any" required></td>
                                                       
                                                       <td class="sub-total">{{number_format((float)$product_return_data->total, 2, '.', '')}}</td>
                                                       <td><button type="button" class="ibtnDel btn btn-md btn-danger">Delete</button></td>
                                                       <input type="hidden" class="product-id" name="product_id[]" value="{{$product_return_data->product_id}}"/>
                                                       <input type="hidden" class="subtotal-value" name="subtotal[]" value="{{$product_return_data->total}}"/>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" class="form-control" name="note">{{$lsms_return_data->note}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
