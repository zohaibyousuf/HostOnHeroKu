            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'transfer.store', 'method' => 'post', 'files' => true, 'id' => 'transfer-form']) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" name="date_time" value="{{ $lims_transfer_data->created_at->toDateString() . ' '. $lims_transfer_data->created_at->toTimeString()  }}" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><strong>Reference No</strong></label>
                                            <input type="text" name="reference_no" class="form-control" value="{{ $lims_transfer_data->reference_no }}" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="row mt-5">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="shipping_cost" class="form-control" value="{{ $lims_transfer_data->shipping_cost }}" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            ...
                            <input type="text" name="edit_qty" class="form-control">
                        </div>
                        <div class="form-group">
                            <label><strong>Unit cost</strong></label>
                            <input type="text" name="edit_unit_cost" class="form-control">
                        </div>
                        <div class="form-group">
...
$('select[name="from_warehouse_id"]').val('1');
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(flag){
                    ...
                    cols += '<td>' + data[1] + '</td>';
                    cols += '<td><input type="text" class="form-control qty" name="qty[]" value="1" /></td>';
...
$("table.order-list").on("click", ".edit-product", function() {
    ...
    $('#exampleModalLabel').text(row_product_name + '(' + row_product_code + ')');
