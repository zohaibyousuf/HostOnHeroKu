            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['route' => ['purchases.update', $lsms_purchase_data->id], 'method' => 'put', 'id' => 'purchase-form']); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <p><strong><?php echo e($lsms_purchase_data->reference_no); ?></strong></p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><strong><?php echo e(trans('file.Supplier')); ?></strong></label>
                                            <input type="text" name="supplier" class="form-control" value="<?php echo e($lsms_purchase_data->supplier); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="shipping_cost" class="form-control" value="<?php echo e($lsms_purchase_data->shipping_cost); ?>" step="any" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $lsms_product_purchase_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_purchase_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <?php
                                                        $lsms_product_data = DB::table('products')->find($product_purchase_data->product_id)?>
                                                       <td><?php echo e($lsms_product_data->name); ?></td>
                                                       <td><?php echo e($lsms_product_data->model_no); ?></td>
                                                       <td><input type="number" name="qty[]" class="form-control qty" value="<?php echo e($product_purchase_data->qty); ?>" step="any" required></td>
                                                       <td><input type="number" name="product_cost[]" class="form-control product-cost" value="<?php echo e($product_purchase_data->product_cost); ?>" step="any" required></td>
                                                       
                                                       <td class="sub-total"><?php echo e(number_format((float)$product_purchase_data->total, 2, '.', '')); ?></td>
                                                       <td><button type="button" class="ibtnDel btn btn-md btn-danger"><?php echo e(trans("file.Delete")); ?></button></td>
                                                       <input type="hidden" class="product-id" name="product_id[]" value="<?php echo e($product_purchase_data->product_id); ?>"/>
                                                       <input type="hidden" class="subtotal-value" name="subtotal[]" value="<?php echo e($product_purchase_data->total); ?>"/>
                                                    </tr>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" class="form-control" name="note"><?php echo e($lsms_purchase_data->note); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
