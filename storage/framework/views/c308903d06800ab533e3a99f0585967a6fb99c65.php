            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('file.Update')); ?> <?php echo e(trans('file.Sale')); ?></h4>
                    </div>
                    <div class="card-body">
                        <p><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</p>
                        <?php echo Form::open(['route' => ['sales.update', $lsms_sale_data->id], 'method' => 'put', 'id' => 'sale-form']); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><strong><?php echo e(trans('file.Invoice')); ?> No</strong></label>
                                            <input type="hidden" name="url" value="<?php echo e(url()->previous()); ?>" />
                                            <p><strong><?php echo e($lsms_sale_data->reference_no); ?></strong></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><strong><?php echo e(trans('file.Customer')); ?> *</strong></label>
                                            <input type="hidden" name="customer_id_hidden" value="<?php echo e($lsms_sale_data->customer_id); ?>" />
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $lsms_product_sale_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_sale_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <?php
                                                        $lsms_product_data = DB::table('products')->find($product_sale_data->product_id)?>
                                                       <td><?php echo e($lsms_product_data->name); ?></td>
                                                       <td><?php echo e($lsms_product_data->model_no); ?></td>
                                                       <td><input type="number" name="qty[]" class="form-control qty" value="<?php echo e($product_sale_data->qty); ?>" step="any" required></td>
                                                       <td><input type="number" name="product_price[]" class="form-control product-price" value="<?php echo e($product_sale_data->product_price); ?>" step="any" required></td>
                                                       
                                                       <td class="sub-total"><?php echo e(number_format((float)$product_sale_data->total, 2, '.', '')); ?></td>
                                                       <td><button type="button" class="ibtnDel btn btn-md btn-danger"><?php echo e(trans("file.Delete")); ?></button></td>
                                                       <input type="hidden" class="product-id" name="product_id[]" value="<?php echo e($product_sale_data->product_id); ?>"/>
                                                       <input type="hidden" class="subtotal-value" name="subtotal[]" value="<?php echo e($product_sale_data->total); ?>"/>
                                                    </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tbody>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" class="form-control" name="note"><?php echo e($lsms_sale_data->note); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
