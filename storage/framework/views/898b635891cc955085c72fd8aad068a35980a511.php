            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('file.Add')); ?> <?php echo e(trans('file.Sale')); ?></h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</p>
                        <?php echo Form::open(['route' => 'sales.store', 'method' => 'post', 'files' => true, 'id' => 'purchase-form']); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <p><strong><?php echo e('sr-' . date("Ymd") . '-'. date("his")); ?></strong> </p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><strong><?php echo e(trans('file.Payment')); ?> <?php echo e(trans('file.Status')); ?></strong></label>
