      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          ...
          <div class="sidenav-header-inner text-center"><span class="brand-big text-center">
            <?php if($settings->site_logo): ?><img src="<?php echo e(url('logo', $settings->site_logo)); ?>">&nbsp;&nbsp;<?php endif; ?><strong><?php echo e($settings->site_title); ?></strong></span>
          </div>
          <!-- Small Brand information, appears on minimized sidebar-->
          <div class="sidenav-header-logo"><span class="brand-small text-center"> <strong><?php echo e($settings->site_title); ?></strong></span></div>
        </div>
        <!-- Sidebar Navigation Menus-->
        <div class="main-menu">
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            <li><a href="<?php echo e(url('/dashboard')); ?>"> <i class="icon-home"></i><?php echo e(trans('file.Dashboard')); ?></a></li>
            <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="icon-list"></i> <?php echo e(trans('file.Product')); ?></a>
              <ul id="product" class="collapse list-unstyled ">
                <li><a href="<?php echo e(route('category.index')); ?>"> <?php echo e(trans('file.Category')); ?></a></li>
                <?php
                ...
                <?php if($index_permission_active): ?>
                  <li><a href="<?php echo e(route('products.index')); ?>"><?php echo e(trans('file.Product')); ?> <?php echo e(trans('file.List')); ?></a></li>
                  ...
                  <?php if($add_permission_active): ?>
                    <li><a href="<?php echo e(route('products.create')); ?>"><?php echo e(trans('file.Add')); ?> <?php echo e(trans('file.Product')); ?></a></li>
                  <?php endif; ?>
                <?php endif; ?>
                <li><a href="<?php echo e(route('product.printBarcode')); ?>"><?php echo e(trans('file.Print Barcode')); ?></a></li>
              </ul>
            </li>
            ...
            ?>
            <?php if($index_permission_active): ?>
            <li><a href="#customer" aria-expanded="false" data-toggle="collapse"> <i class="icon-user"></i><?php echo e(trans('file.Customer')); ?></a>
              ...
              <ul id="purchase" class="collapse list-unstyled ">
                <?php $add_permission_active = DB::table('permissions')
                      ...
                      ->where([
                        ...
                        ['role_id', $role->id] ])->first();
                ?>
                <li><a href="<?php echo e(route('purchases.index')); ?>"><?php echo e(trans('file.Purchase')); ?> <?php echo e(trans('file.List')); ?></a></li>
                <?php if($add_permission_active): ?>
                <li><a href="<?php echo e(route('purchases.create')); ?>"><?php echo e(trans('file.Add')); ?> <?php echo e(trans('file.Purchase')); ?></a></li>
                <li><a href="<?php echo e(url('purchases/purchase_by_csv')); ?>"><?php echo e(trans('file.Import')); ?> <?php echo e(trans('file.Purchase')); ?> <?php echo e(trans('file.By')); ?> CSV</a></li>
                <?php endif; ?>
              </ul>
            </li>
            <?php endif; ?>
            ...
            ?>
            <?php if($index_permission_active): ?>
            <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="icon-pencil-case"></i><?php echo e(trans('file.Sale')); ?></a>
              <ul id="sale" class="collapse list-unstyled ">
                <li><a href="<?php echo e(route('sales.index')); ?>"><?php echo e(trans('file.Sale')); ?> <?php echo e(trans('file.List')); ?></a></li>
                <?php $add_permission_active = DB::table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                ...
                ?>
                <?php if($add_permission_active): ?>
                <li><a href="<?php echo e(route('sales.create')); ?>"><?php echo e(trans('file.Add')); ?> <?php echo e(trans('file.Sale')); ?></a></li>
                <li><a href="<?php echo e(url('sales/sale_by_csv')); ?>"><?php echo e(trans('file.Import')); ?> <?php echo e(trans('file.Sale')); ?> <?php echo e(trans('file.By')); ?> CSV</a></li>
                <?php endif; ?>
              </ul>
            </li>
            <?php endif; ?>
            ...
            ?>
            <?php if($index_permission_active): ?>
            <li><a href="#return" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-undo"></i><?php echo e(trans('file.Return')); ?></a>
              <ul id="return" class="collapse list-unstyled ">
                <li><a href="<?php echo e(route('returns.index')); ?>"><?php echo e(trans('file.Return')); ?> <?php echo e(trans('file.List')); ?></a></li>
                <?php $add_permission_active = DB::table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                ...
                ?>
                <?php if($add_permission_active): ?>
                  <li><a href="<?php echo e(route('returns.create')); ?>"><?php echo e(trans('file.Add')); ?> <?php echo e(trans('file.Return')); ?></a></li>
                <?php endif; ?>
              </ul>
            </li>
            <?php endif; ?>
            ...
            ?>
            <?php if($index_permission_active): ?>
            <li><a href="#user" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-user"></i><?php echo e(trans('file.User')); ?></a>
              <ul id="user" class="collapse list-unstyled ">
                <li><a href="<?php echo e(route('users.index')); ?>"><?php echo e(trans('file.User')); ?> <?php echo e(trans('file.List')); ?></a></li>
                <?php $add_permission_active = DB::table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                ...
                ?>
                <?php if($add_permission_active): ?>
                <li><a href="<?php echo e(route('users.create')); ?>"><?php echo e(trans('file.Add')); ?> <?php echo e(trans('file.User')); ?></a></li>
                <?php endif; ?>
              </ul>
            </li>
            <?php endif; ?>
            <?php
                ...
                $due_report_active = DB::table('permissions')
                      ...
                      ->where([
                        ...
                        ['role_id', $role->id] ])->first();
              ?>
            <li><a href="#report" aria-expanded="false" data-toggle="collapse"> <i class="icon-page"></i><?php echo e(trans('file.Report')); ?>s</a>
              <ul id="report" class="collapse list-unstyled ">
                ...
                <li>
                  ...
                  <a id="profitLoss-link" href=""><?php echo e(trans('file.profit')); ?> / <?php echo e(trans('file.Loss')); ?></a>
                  <?php echo Form::close(); ?>
                ...
                <li>
                  <?php echo Form::open(['route' => 'report.byDate', 'method' => 'post', 'id' => 'report-form']); ?>
                ...
                <li>
                  <?php echo Form::open(['route' => 'report.purchaseByDate', 'method' => 'post', 'id' => 'purchase-report-form']); ?>
                ...
                <li>
                  <?php echo Form::open(['route' => 'report.saleByDate', 'method' => 'post', 'id' => 'sale-report-form']); ?>
            ...
            <?php if($role->id <= 2): ?>
            <li><a href="#settings" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-cog"></i><?php echo e(trans('file.Settings')); ?></a>
              <ul id="settings" class="collapse list-unstyled ">
                <li>
                  <a href="<?php echo e(route('roles.index')); ?>"><?php echo e(trans('file.Role')); ?></a>
                </li>
                <li>
                  <a href="<?php echo e(route('settings.index')); ?>"><?php echo e(trans('file.General Setting')); ?></a>
                </li>
              </ul>
            </li>
            <?php endif; ?>
    ...
    <div class="page">
        ...
        <nav class="navbar">
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              <div class="navbar-header"><a href="<?php echo e(route('user.profile', ['id' => Auth::id()])); ?>" class="navbar-brand">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                <li class="nav-item dropdown">
                  <a class="dropdown-item" href="<?php echo e(url('/dashboard')); ?>"> <i class="fa fa-home"></i> <?php echo e(trans('file.Dashboard')); ?></a>
                </li>
                <?php if($product_qty_alert_active && $alert_product > 0): ?>
                <li class="nav-item">
                ...
                <?php endif; ?>
                <li class="nav-item dropdown"> <a class="dropdown-item" href="<?php echo e(route('user.profile', ['id' => Auth::id()])); ?>"><i class="fa fa-user"></i> <?php echo e(trans('file.Profile')); ?></a>
                </li>
                <li class="nav-item">
                      <a rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-item"><i class="fa fa-language"></i> <?php echo e(__('file.language')); ?>
                ...
                <?php if($role->id <= 2): ?>
                <li class="nav-item dropdown"> <a class="dropdown-item" href="<?php echo e(route('settings.index')); ?>"><i class="fa fa-cog"></i> <?php echo e(trans('file.Settings')); ?></a>
                </li>
                <?php endif; ?>
                <li class="nav-item">
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="exampleModalLabel" class="modal-title"><?php echo e($settings->site_title); ?></h5>
                    <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
                </div>
                <div class="modal-body">
                  <p class="italic"><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</p>
                    <?php echo Form::open(['route' => 'report.customerByDate', 'method' => 'post']); ?>

                    <?php 
                      $lsms_customer_list = DB::table('customers')->where('is_active', true)->get();
                    ?>
                      <div class="form-group">
                          <label><strong><?php echo e(__('file.Customer')); ?> *</strong></label>
      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
              <p>&copy; <?php echo e($settings->site_title); ?></p>
            </div>
            <div class="col-sm-6 text-right">
              <p><?php echo e(__('file.Developed By')); ?> <a href="http://lion-coders.com" class="external">LionCoders</a></p>
            </div>
          </div>
        </div>
      </footer>
